...
# Example curl command for fetching Spond posts
...
curl 'https://api.spond.com/core/v1/posts?max=5&includeComments=true&includeReadStatus=true&includeSeenCount=true&type=PLAIN' \
